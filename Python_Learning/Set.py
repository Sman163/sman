# Sets are enclosed in Curly Brases
# Sets aren't Ordered and not indexed
# you can't slice, index
# sets has only immutable Data Types (Num,str,tuple) ,Lists and dictionary aren't icluded
# Set items must be Unique (any repeated element will remove)
